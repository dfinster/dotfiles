...
- Added antidote automatic update functionality to dotfiles-update:78-87. When you run dotfiles-update, it will now automatically update antidote plugins using antidote update after successfully pulling dotfiles changes.
